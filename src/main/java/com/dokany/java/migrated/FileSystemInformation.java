...
public final class FileSystemInformation {
	...
	//TODO: remove this and serialNumber
	 ...
	 */
	public FileSystemInformation(final String volumeName, final int serialNumber, final String fileSystemName) {
	...
	public boolean equals(final Object o) {
		...
		if (!(o instanceof FileSystemInformation)) return false;
		final FileSystemInformation other = (FileSystemInformation) o;
	...
	public FileSystemInformation(final int maxComponentLength, final String name, final int serialNumber, final String fileSystemName, final EnumIntegerSet<FileSystemFlag> fileSystemFeatures) {
